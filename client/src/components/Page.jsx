...
const LandingPage = () => {
  ...
  const fetchdata = async () => {
    try {
      ...
      // Check if the result is HTML code for the login page
  ...
  const isLoginPage = (html) => {
    // Check if the HTML contains elements specific to the login page
    // For example, check for elements like <h2 class="form-signin-heading">Login with OAuth 2.0</h2>
    // You can customize this logic based on the structure of your login page HTML
  ...
  return (
    <div className="landing-page-container">
      {typeof data === 'string' && !isLoginPage(data) ? ( // Conditionally render if data is not empty and not the login page
        <>
